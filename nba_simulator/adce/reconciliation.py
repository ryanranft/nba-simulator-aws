...
Migrated from scripts/reconciliation/reconciliation_daemon.py during Phase 6 refactoring.
...
Usage:
    ...
    daemon = ReconciliationDaemon(interval_hours=1)
    daemon.run()
"""
...
Examples:
  ...
  python -m nba_simulator.adce.reconciliation
  ...
  python -m nba_simulator.adce.reconciliation --interval-hours 2

  # Run once and exit (for testing)
  python -m nba_simulator.adce.reconciliation --run-once

  # Dry run mode (don't generate task queue)
  python -m nba_simulator.adce.reconciliation --dry-run

  # Use AWS S3 Inventory instead of sampling
  python -m nba_simulator.adce.reconciliation --use-aws-inventory
        """,
    )
