...
Migrated from scripts/etl/scraper_telemetry.py to nba_simulator.etl.monitoring

Usage:
    from nba_simulator.etl.monitoring import ScraperTelemetry, MetricsCollector
