...
class ScraperErrorHandler:
    ...
    def classify_error(self, error: Exception) -> tuple[ErrorCategory, ErrorSeverity]:
        ...
        # Data validation
        if 'validation' in error_str or 'invalid data' in error_str or 'schema' in error_str:
        ...
        # Database errors
        if any(x in error_str for x in ['database', 'postgresql', 'connection pool', 'sql']):
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "retry_rate": total_retries / len(self.error_history) if self.error_history else 0.0
        }
