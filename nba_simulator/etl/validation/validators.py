...
class ValidationReport:
    ...
    def log_results(self) -> None:
        ...
        logger.info(f"Validation Report - {self.source.value if self.source else 'Unknown'}")
        logger.info(f"Valid: {self.is_valid} | Errors: {self.error_count} | Warnings: {self.warning_count}")
...
def validate_game(data: Dict[str, Any], source: Optional[DataSource] = None) -> ValidationReport:
    """
    Validate game data.
...
def validate_play_by_play(data: Dict[str, Any], source: Optional[DataSource] = None) -> ValidationReport:
    """
    Validate play-by-play data.
...
def validate_box_score(data: Dict[str, Any], source: Optional[DataSource] = None) -> ValidationReport:
    """
    Validate box score data.
