...
class HooprAgent(BaseAgent):
    ...
    def _execute_core(self) -> bool:
        ...
        try:
            ...
            # Calculate metrics
            self.metrics.items_processed = len(self.games_processed) + len(self.games_failed)
    ...
    def _collect_game_data(self, game_id: str, data_type: str) -> bool:
        ...
        try:
            ...
            self.log_error(
                f"Error collecting {data_type} for game {game_id}: {e}"
            )
            return False
    ...
    def get_collection_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': (
                ...
                (len(self.games_processed) + len(self.games_failed)) * 100
                if (self.games_processed or self.games_failed) else 0
            ),
