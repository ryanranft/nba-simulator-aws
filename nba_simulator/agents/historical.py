...
class HistoricalAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(
            agent_name="historical", config=config, priority=AgentPriority.NORMAL
        )
        ...
        try:
            ...
            if total_games > 0:
                self.metrics.quality_score = (
                    ...
                    / (self.metrics.items_successful + self.metrics.items_failed)
                    * 100
                )
            else:
    ...
    def _validate_era_rules(self, era_name: str, games: List[Dict[str, Any]]) -> None:
        """
