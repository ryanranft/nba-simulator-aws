...
class QualityAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(
            agent_name="quality_validator", config=config, priority=AgentPriority.HIGH
        )
    ...
    def _validate_config(self) -> bool:
        ...
        try:
            ...
            if (
                not isinstance(self.anomaly_threshold, (int, float))
    ...
    def _detect_score_anomalies(self) -> Optional[QualityCheck]:
        ...
        try:
            ...
            anomalies = sum(
                1 for score in all_scores if score < lower_bound or score > upper_bound
            )
