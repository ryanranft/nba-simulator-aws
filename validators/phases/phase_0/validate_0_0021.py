...
Usage:
    python validators/phases/phase_0/validate_0_0021.py
    python validators/phases/phase_0/validate_0_0021.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 0.0021")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase00021Validator(verbose=args.verbose)
