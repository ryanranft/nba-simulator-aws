...
Usage:
    python validators/phases/phase_0/validate_0_0020.py
    python validators/phases/phase_0/validate_0_0020.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 0.0020")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase00020Validator(verbose=args.verbose)
