...
Usage:
    python validators/phases/phase_0/validate_0_0019.py
    python validators/phases/phase_0/validate_0_0019.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 0.0019")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase00019Validator(verbose=args.verbose)
