...
Usage:
    python validators/phases/phase_0/validate_0_8.py
    python validators/phases/phase_0/validate_0_8.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 0.8")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase08Validator(verbose=args.verbose)
