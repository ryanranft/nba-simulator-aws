...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 0.0022")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase00022Validator(verbose=args.verbose)
