...
Usage:
    python validators/phases/phase_2/validate_2_0.py
    python validators/phases/phase_2/validate_2_0.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 2.0")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20Validator(verbose=args.verbose)
