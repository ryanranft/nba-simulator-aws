...
Usage:
    python validators/phases/phase_2/validate_2_0000.py
    python validators/phases/phase_2/validate_2_0000.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 2.0000")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20000Validator(verbose=args.verbose)
