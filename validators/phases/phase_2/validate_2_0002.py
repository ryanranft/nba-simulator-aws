...
Usage:
    python validators/phases/phase_2/validate_2_0002.py
    python validators/phases/phase_2/validate_2_0002.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 2.0002")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20002Validator(verbose=args.verbose)
