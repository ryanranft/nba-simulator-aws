...
Usage:
    python validators/phases/phase_2/validate_2_0006.py
    python validators/phases/phase_2/validate_2_0006.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 2.0006")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20006Validator(verbose=args.verbose)
