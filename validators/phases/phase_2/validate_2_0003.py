...
Usage:
    python validators/phases/phase_2/validate_2_0003.py
    python validators/phases/phase_2/validate_2_0003.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 2.0003")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20003Validator(verbose=args.verbose)
