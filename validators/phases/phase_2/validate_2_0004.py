...
Usage:
    python validators/phases/phase_2/validate_2_0004.py
    python validators/phases/phase_2/validate_2_0004.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate 2.0004")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase20004Validator(verbose=args.verbose)
