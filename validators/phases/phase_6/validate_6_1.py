...
Usage:
    python validators/phases/phase_6/validate_6_1.py
    python validators/phases/phase_6/validate_6_1.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 6.1")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase61Validator(verbose=args.verbose)
