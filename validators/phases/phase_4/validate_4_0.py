...
Usage:
    python validators/phases/phase_4/validate_4_0.py
    python validators/phases/phase_4/validate_4_0.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 4.0")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase40Validator(verbose=args.verbose)
