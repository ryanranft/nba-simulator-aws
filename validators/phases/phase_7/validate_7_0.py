...
Usage:
    python validators/phases/phase_7/validate_7_0.py
    python validators/phases/phase_7/validate_7_0.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 7.0")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase70Validator(verbose=args.verbose)
