...
Usage:
    python validators/phases/phase_3/validate_3_0.py
    python validators/phases/phase_3/validate_3_0.py --verbose
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Validate Phase 3.0")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
    args = parser.parse_args()

    validator = Phase30Validator(verbose=args.verbose)
