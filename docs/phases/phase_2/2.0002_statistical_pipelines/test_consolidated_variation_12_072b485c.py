...
from implement_consolidated_variation_12_072b485c import (
    DataValidationPipelineVariation12,
)
...
def run_tests():
    ...
    suite.addTests(
        loader.loadTestsFromTestCase(TestDataValidationPipelineVariation12Integration)
    )
