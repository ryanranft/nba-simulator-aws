...
def run_tests():
    ...
    # Add test classes
    suite.addTests(loader.loadTestsFromTestCase(TestAutomatedFeatureEngineeringVariation67))
    suite.addTests(loader.loadTestsFromTestCase(TestAutomatedFeatureEngineeringVariation67Integration))
