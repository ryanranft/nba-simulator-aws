...
from implement_consolidated_variation_4_af134df3 import (
    PerformanceOptimizationVariation4,
)
...
def run_tests():
    ...
    suite.addTests(
        loader.loadTestsFromTestCase(TestPerformanceOptimizationVariation4Integration)
    )
