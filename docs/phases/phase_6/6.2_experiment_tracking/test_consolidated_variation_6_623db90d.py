...
from implement_consolidated_variation_6_623db90d import (
    ModelPerformanceTrackingVariation6,
)
...
def run_tests():
    ...
    suite.addTests(
        loader.loadTestsFromTestCase(TestModelPerformanceTrackingVariation6Integration)
    )
