...
from implement_consolidated_consolidated_rec_40_8018 import (
    ApplyFeatureScalingToImproveModelPerformance,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestApplyFeatureScalingToImproveModelPerformance)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestApplyFeatureScalingToImproveModelPerformanceIntegration
        )
    )
