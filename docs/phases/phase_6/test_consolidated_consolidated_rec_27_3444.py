...
from implement_consolidated_consolidated_rec_27_3444 import (
    MonitorModelPerformanceWithPercentiles,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestMonitorModelPerformanceWithPercentiles)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestMonitorModelPerformanceWithPercentilesIntegration
        )
    )
