...
from implement_variation_43_139bb1f7 import SecurityImplementationVariation43
...
def run_tests():
    ...
    suite.addTests(loader.loadTestsFromTestCase(TestSecurityImplementationVariation43Integration))
