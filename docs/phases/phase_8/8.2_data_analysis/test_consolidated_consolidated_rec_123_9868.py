...
from implement_consolidated_consolidated_rec_123_9868 import (
    ClusterAnalysisForPlayerSegmentation,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestClusterAnalysisForPlayerSegmentation)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestClusterAnalysisForPlayerSegmentationIntegration
        )
    )
