...
from implement_variation_57_e53ca947 import SecurityImplementationVariation57
...
def run_tests():
    ...
    suite.addTests(loader.loadTestsFromTestCase(TestSecurityImplementationVariation57Integration))
