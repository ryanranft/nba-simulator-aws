#!/usr/bin/env python3
"""
Test Suite: Train Model With Two Objectives

Tests for rec_212 implementation.
"""
...
from implement_rec_212 import TrainModelWithTwoObjectives


class TestRec212(unittest.TestCase):
    """Test suite for Train Model With Two Objectives."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = TrainModelWithTwoObjectives()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec212)
