#!/usr/bin/env python3
"""
Test Suite: Add Context to Chatbot

Tests for rec_178 implementation.
"""
...
from implement_rec_178 import AddContextToChatbot


class TestRec178(unittest.TestCase):
    """Test suite for Add Context to Chatbot."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = AddContextToChatbot()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec178)
