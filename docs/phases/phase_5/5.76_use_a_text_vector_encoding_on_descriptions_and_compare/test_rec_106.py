#!/usr/bin/env python3
"""
Test Suite: Use a Text Vector Encoding on descriptions and compare

Tests for rec_106 implementation.
"""
...
from implement_rec_106 import UseATextVectorEncodingOnDescriptionsAndCompare


class TestRec106(unittest.TestCase):
    """Test suite for Use a Text Vector Encoding on descriptions and compare."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseATextVectorEncodingOnDescriptionsAndCompare()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec106)
