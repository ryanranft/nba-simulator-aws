#!/usr/bin/env python3
"""
Test Suite: Experiment with Dropout Regularization

Tests for rec_095 implementation.
"""
...
from implement_rec_095 import ExperimentWithDropoutRegularization


class TestRec095(unittest.TestCase):
    """Test suite for Experiment with Dropout Regularization."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ExperimentWithDropoutRegularization()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec095)
