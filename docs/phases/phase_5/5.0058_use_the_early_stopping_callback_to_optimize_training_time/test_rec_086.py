#!/usr/bin/env python3
"""
Test Suite: Use the Early Stopping Callback to Optimize Training Time

Tests for rec_086 implementation.
"""
...
from implement_rec_086 import UseTheEarlyStoppingCallbackToOptimizeTrainingTime


class TestRec086(unittest.TestCase):
    """Test suite for Use the Early Stopping Callback to Optimize Training Time."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseTheEarlyStoppingCallbackToOptimizeTrainingTime()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec086)
