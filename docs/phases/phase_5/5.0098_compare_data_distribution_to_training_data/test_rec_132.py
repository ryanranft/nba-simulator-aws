#!/usr/bin/env python3
"""
Test Suite: Compare Data Distribution to Training Data

Tests for rec_132 implementation.
"""
...
from implement_rec_132 import CompareDataDistributionToTrainingData


class TestRec132(unittest.TestCase):
    """Test suite for Compare Data Distribution to Training Data."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CompareDataDistributionToTrainingData()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec132)
