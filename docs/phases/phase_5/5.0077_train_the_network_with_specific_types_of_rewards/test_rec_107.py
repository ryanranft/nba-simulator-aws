#!/usr/bin/env python3
"""
Test Suite: Train the network with specific types of rewards

Tests for rec_107 implementation.
"""
...
from implement_rec_107 import TrainTheNetworkWithSpecificTypesOfRewards


class TestRec107(unittest.TestCase):
    """Test suite for Train the network with specific types of rewards."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = TrainTheNetworkWithSpecificTypesOfRewards()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec107)
