...
from implement_consolidated_rec_54_9775 import (
    EmployBootstrapResamplingForModelInference,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestEmployBootstrapResamplingForModelInference)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestEmployBootstrapResamplingForModelInferenceIntegration
        )
    )
