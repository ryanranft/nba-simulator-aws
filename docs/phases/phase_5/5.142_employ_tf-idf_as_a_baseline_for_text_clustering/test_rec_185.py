#!/usr/bin/env python3
"""
Test Suite: Employ TF-IDF as a Baseline for Text Clustering

Tests for rec_185 implementation.
"""
...
from implement_rec_185 import EmployTfidfAsABaselineForTextClustering


class TestRec185(unittest.TestCase):
    """Test suite for Employ TF-IDF as a Baseline for Text Clustering."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = EmployTfidfAsABaselineForTextClustering()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec185)
