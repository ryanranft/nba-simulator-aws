...
from implement_consolidated_consolidated_rec_78_7121 import (
    MonitorModelAccuracyWithTraintestSplits,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestMonitorModelAccuracyWithTraintestSplits)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestMonitorModelAccuracyWithTraintestSplitsIntegration
        )
    )
