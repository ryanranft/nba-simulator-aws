#!/usr/bin/env python3
"""
Test Suite: Create an Instruction Dataset for NBA Analysis

Tests for rec_035 implementation.
"""
...
from implement_rec_035 import CreateAnInstructionDatasetForNbaAnalysis


class TestRec035(unittest.TestCase):
    """Test suite for Create an Instruction Dataset for NBA Analysis."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CreateAnInstructionDatasetForNbaAnalysis()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec035)
