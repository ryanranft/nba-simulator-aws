#!/usr/bin/env python3
"""
Test Suite: Model Selection for Regression

Tests for rec_065 implementation.
"""
...
from implement_rec_065 import ModelSelectionForRegression


class TestRec065(unittest.TestCase):
    """Test suite for Model Selection for Regression."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ModelSelectionForRegression()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec065)
