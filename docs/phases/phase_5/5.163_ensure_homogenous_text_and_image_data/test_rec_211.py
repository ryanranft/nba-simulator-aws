#!/usr/bin/env python3
"""
Test Suite: Ensure Homogenous Text and Image Data.

Tests for rec_211 implementation.
"""
...
from implement_rec_211 import EnsureHomogenousTextAndImageData


class TestRec211(unittest.TestCase):
    """Test suite for Ensure Homogenous Text and Image Data.."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = EnsureHomogenousTextAndImageData()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec211)
