#!/usr/bin/env python3
"""
Test Suite: Evaluate RNN Extensions: GRUs

Tests for rec_099 implementation.
"""
...
from implement_rec_099 import EvaluateRnnExtensionsGrus


class TestRec099(unittest.TestCase):
    """Test suite for Evaluate RNN Extensions: GRUs."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = EvaluateRnnExtensionsGrus()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec099)
