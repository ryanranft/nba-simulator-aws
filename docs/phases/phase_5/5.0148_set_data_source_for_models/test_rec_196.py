#!/usr/bin/env python3
"""
Test Suite: Set Data Source for Models

Tests for rec_196 implementation.
"""
...
from implement_rec_196 import SetDataSourceForModels


class TestRec196(unittest.TestCase):
    """Test suite for Set Data Source for Models."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = SetDataSourceForModels()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec196)
