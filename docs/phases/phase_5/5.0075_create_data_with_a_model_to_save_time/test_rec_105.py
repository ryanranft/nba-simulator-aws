#!/usr/bin/env python3
"""
Test Suite: Create data with a model to save time.

Tests for rec_105 implementation.
"""
...
from implement_rec_105 import CreateDataWithAModelToSaveTime


class TestRec105(unittest.TestCase):
    """Test suite for Create data with a model to save time.."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CreateDataWithAModelToSaveTime()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec105)
