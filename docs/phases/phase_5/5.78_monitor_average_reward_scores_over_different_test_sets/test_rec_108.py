#!/usr/bin/env python3
"""
Test Suite: Monitor average reward scores over different test sets.

Tests for rec_108 implementation.
"""
...
from implement_rec_108 import MonitorAverageRewardScoresOverDifferentTestSets


class TestRec108(unittest.TestCase):
    """Test suite for Monitor average reward scores over different test sets.."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = MonitorAverageRewardScoresOverDifferentTestSets()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec108)
