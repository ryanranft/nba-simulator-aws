#!/usr/bin/env python3
"""
Test Suite: Maximize Expected Value by Choosing the Best Odds

Tests for rec_155 implementation.
"""
...
from implement_rec_155 import MaximizeExpectedValueByChoosingTheBestOdds


class TestRec155(unittest.TestCase):
    """Test suite for Maximize Expected Value by Choosing the Best Odds."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = MaximizeExpectedValueByChoosingTheBestOdds()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec155)
