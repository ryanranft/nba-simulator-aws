...
from implement_consolidated_consolidated_rec_101_3020 import (
    EmployGridSearchForHyperparameterTuning,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestEmployGridSearchForHyperparameterTuning)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestEmployGridSearchForHyperparameterTuningIntegration
        )
    )
