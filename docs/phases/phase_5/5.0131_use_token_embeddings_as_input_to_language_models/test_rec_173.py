#!/usr/bin/env python3
"""
Test Suite: Use Token Embeddings as Input to Language Models

Tests for rec_173 implementation.
"""
...
from implement_rec_173 import UseTokenEmbeddingsAsInputToLanguageModels


class TestRec173(unittest.TestCase):
    """Test suite for Use Token Embeddings as Input to Language Models."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseTokenEmbeddingsAsInputToLanguageModels()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec173)
