#!/usr/bin/env python3
"""
Test Suite: Capture ML Metadata

Tests for rec_013 implementation.
"""
...
from implement_rec_013 import CaptureMlMetadata


class TestRec013(unittest.TestCase):
    """Test suite for Capture ML Metadata."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CaptureMlMetadata()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec013)
