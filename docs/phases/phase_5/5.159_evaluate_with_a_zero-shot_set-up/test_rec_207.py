#!/usr/bin/env python3
"""
Test Suite: Evaluate with a Zero-Shot Set-Up

Tests for rec_207 implementation.
"""
...
from implement_rec_207 import EvaluateWithAZeroshotSetup


class TestRec207(unittest.TestCase):
    """Test suite for Evaluate with a Zero-Shot Set-Up."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = EvaluateWithAZeroshotSetup()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec207)
