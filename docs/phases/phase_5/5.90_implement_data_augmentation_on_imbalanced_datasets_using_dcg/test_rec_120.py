#!/usr/bin/env python3
"""
Test Suite: Implement Data Augmentation on Imbalanced Datasets using DCGAN

Tests for rec_120 implementation.
"""
...
from implement_rec_120 import ImplementDataAugmentationOnImbalancedDatasetsUsingDcgan


class TestRec120(unittest.TestCase):
    """Test suite for Implement Data Augmentation on Imbalanced Datasets using DCGAN."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ImplementDataAugmentationOnImbalancedDatasetsUsingDcgan()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec120)
