# Implementation Guide: Incorporate a regularization parameter
...
### Step 1: Step 1: Construct the objective function with the Tikhonov term.
...
### Step 2: Step 2: Iteratively update the estimate of the parameters to find optimal parameters.
