#!/usr/bin/env python3
"""
Test Suite: Incorporate a regularization parameter

Tests for rec_063 implementation.
"""
...
from implement_rec_063 import IncorporateARegularizationParameter


class TestRec063(unittest.TestCase):
    """Test suite for Incorporate a regularization parameter."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = IncorporateARegularizationParameter()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec063)
