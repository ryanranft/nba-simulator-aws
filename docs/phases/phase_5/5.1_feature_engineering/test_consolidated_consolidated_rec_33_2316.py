...
from implement_consolidated_consolidated_rec_33_2316 import (
    MonitorDataDistributionShiftsInFeatureStore,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestMonitorDataDistributionShiftsInFeatureStore)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestMonitorDataDistributionShiftsInFeatureStoreIntegration
        )
    )
