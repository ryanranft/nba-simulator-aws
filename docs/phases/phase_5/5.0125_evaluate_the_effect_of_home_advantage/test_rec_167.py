#!/usr/bin/env python3
"""
Test Suite: Evaluate the Effect of Home Advantage

Tests for rec_167 implementation.
"""
...
from implement_rec_167 import EvaluateTheEffectOfHomeAdvantage


class TestRec167(unittest.TestCase):
    """Test suite for Evaluate the Effect of Home Advantage."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = EvaluateTheEffectOfHomeAdvantage()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec167)
