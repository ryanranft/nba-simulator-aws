#!/usr/bin/env python3
"""
Test Suite: Use Test Cases to Help Validate Outputs

Tests for rec_186 implementation.
"""
...
from implement_rec_186 import UseTestCasesToHelpValidateOutputs


class TestRec186(unittest.TestCase):
    """Test suite for Use Test Cases to Help Validate Outputs."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseTestCasesToHelpValidateOutputs()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec186)
