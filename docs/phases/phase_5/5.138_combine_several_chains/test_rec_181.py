#!/usr/bin/env python3
"""
Test Suite: Combine Several Chains

Tests for rec_181 implementation.
"""
...
from implement_rec_181 import CombineSeveralChains


class TestRec181(unittest.TestCase):
    """Test suite for Combine Several Chains."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CombineSeveralChains()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec181)
