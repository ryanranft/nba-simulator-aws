#!/usr/bin/env python3
"""
Test Suite: Leverage the Keras Functional API

Tests for rec_091 implementation.
"""
...
from implement_rec_091 import LeverageTheKerasFunctionalApi


class TestRec091(unittest.TestCase):
    """Test suite for Leverage the Keras Functional API."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = LeverageTheKerasFunctionalApi()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec091)
