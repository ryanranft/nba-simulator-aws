#!/usr/bin/env python3
"""
Test Suite: Design a model with a wide range of testability

Tests for rec_109 implementation.
"""
...
from implement_rec_109 import DesignAModelWithAWideRangeOfTestability


class TestRec109(unittest.TestCase):
    """Test suite for Design a model with a wide range of testability."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = DesignAModelWithAWideRangeOfTestability()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec109)
