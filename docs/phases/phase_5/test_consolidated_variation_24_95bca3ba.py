...
from implement_consolidated_variation_24_95bca3ba import (
    RealtimePredictionEngineVariation24,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestRealtimePredictionEngineVariation24)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(TestRealtimePredictionEngineVariation24Integration)
    )
