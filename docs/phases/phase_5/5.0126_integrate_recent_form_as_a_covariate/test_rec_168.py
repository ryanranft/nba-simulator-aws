#!/usr/bin/env python3
"""
Test Suite: Integrate Recent Form as a Covariate

Tests for rec_168 implementation.
"""
...
from implement_rec_168 import IntegrateRecentFormAsACovariate


class TestRec168(unittest.TestCase):
    """Test suite for Integrate Recent Form as a Covariate."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = IntegrateRecentFormAsACovariate()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec168)
