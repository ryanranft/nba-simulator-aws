#!/usr/bin/env python3
"""
Test Suite: Compare the use of recurrent and attentional models

Tests for rec_103 implementation.
"""
...
from implement_rec_103 import CompareTheUseOfRecurrentAndAttentionalModels


class TestRec103(unittest.TestCase):
    """Test suite for Compare the use of recurrent and attentional models."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = CompareTheUseOfRecurrentAndAttentionalModels()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec103)
