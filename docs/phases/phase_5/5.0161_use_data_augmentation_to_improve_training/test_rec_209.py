#!/usr/bin/env python3
"""
Test Suite: Use Data Augmentation to Improve Training.

Tests for rec_209 implementation.
"""
...
from implement_rec_209 import UseDataAugmentationToImproveTraining


class TestRec209(unittest.TestCase):
    """Test suite for Use Data Augmentation to Improve Training.."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseDataAugmentationToImproveTraining()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec209)
