#!/usr/bin/env python3
"""
Test Suite: Model with Gaussian Distributions.

Tests for rec_216 implementation.
"""
...
from implement_rec_216 import ModelWithGaussianDistributions


class TestRec216(unittest.TestCase):
    """Test suite for Model with Gaussian Distributions.."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ModelWithGaussianDistributions()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec216)
