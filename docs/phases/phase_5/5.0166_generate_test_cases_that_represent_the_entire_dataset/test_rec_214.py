#!/usr/bin/env python3
"""
Test Suite: Generate Test Cases That Represent the Entire Dataset

Tests for rec_214 implementation.
"""
...
from implement_rec_214 import GenerateTestCasesThatRepresentTheEntireDataset


class TestRec214(unittest.TestCase):
    """Test suite for Generate Test Cases That Represent the Entire Dataset."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = GenerateTestCasesThatRepresentTheEntireDataset()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec214)
