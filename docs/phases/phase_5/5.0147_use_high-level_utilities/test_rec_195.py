#!/usr/bin/env python3
"""
Test Suite: Use High-level Utilities

Tests for rec_195 implementation.
"""
...
from implement_rec_195 import UseHighlevelUtilities


class TestRec195(unittest.TestCase):
    """Test suite for Use High-level Utilities."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UseHighlevelUtilities()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec195)
