#!/usr/bin/env python3
"""
Test Suite: Utilize attention to model NBA game play

Tests for rec_102 implementation.
"""
...
from implement_rec_102 import UtilizeAttentionToModelNbaGamePlay


class TestRec102(unittest.TestCase):
    """Test suite for Utilize attention to model NBA game play."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = UtilizeAttentionToModelNbaGamePlay()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec102)
