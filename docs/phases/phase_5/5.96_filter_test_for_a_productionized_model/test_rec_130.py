#!/usr/bin/env python3
"""
Test Suite: Filter Test for a Productionized Model

Tests for rec_130 implementation.
"""
...
from implement_rec_130 import FilterTestForAProductionizedModel


class TestRec130(unittest.TestCase):
    """Test suite for Filter Test for a Productionized Model."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = FilterTestForAProductionizedModel()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec130)
