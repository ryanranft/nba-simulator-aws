#!/usr/bin/env python3
"""
Test Suite: Implement Subword Tokenization with BPE or WordPiece

Tests for rec_172 implementation.
"""
...
from implement_rec_172 import ImplementSubwordTokenizationWithBpeOrWordpiece


class TestRec172(unittest.TestCase):
    """Test suite for Implement Subword Tokenization with BPE or WordPiece."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ImplementSubwordTokenizationWithBpeOrWordpiece()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec172)
