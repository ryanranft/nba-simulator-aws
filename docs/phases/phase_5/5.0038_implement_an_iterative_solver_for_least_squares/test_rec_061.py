#!/usr/bin/env python3
"""
Test Suite: Implement an Iterative Solver for Least Squares

Tests for rec_061 implementation.
"""
...
from implement_rec_061 import ImplementAnIterativeSolverForLeastSquares


class TestRec061(unittest.TestCase):
    """Test suite for Implement an Iterative Solver for Least Squares."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ImplementAnIterativeSolverForLeastSquares()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec061)
