#!/usr/bin/env python3
"""
Test Suite: Implement a System to Handle Data Latency

Tests for rec_170 implementation.
"""
...
from implement_rec_170 import ImplementASystemToHandleDataLatency


class TestRec170(unittest.TestCase):
    """Test suite for Implement a System to Handle Data Latency."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ImplementASystemToHandleDataLatency()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec170)
