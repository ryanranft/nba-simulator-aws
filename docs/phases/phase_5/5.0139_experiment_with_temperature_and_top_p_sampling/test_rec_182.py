#!/usr/bin/env python3
"""
Test Suite: Experiment with Temperature and Top_p Sampling

Tests for rec_182 implementation.
"""
...
from implement_rec_182 import ExperimentWithTemperatureAndTop_pSampling


class TestRec182(unittest.TestCase):
    """Test suite for Experiment with Temperature and Top_p Sampling."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ExperimentWithTemperatureAndTop_pSampling()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec182)
