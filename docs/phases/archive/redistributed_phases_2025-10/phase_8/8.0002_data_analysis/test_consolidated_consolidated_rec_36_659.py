...
from implement_consolidated_consolidated_rec_36_659 import (
    ImplementFeatureImportanceAnalysis,
)
...
def run_tests():
    ...
    suite.addTests(
        loader.loadTestsFromTestCase(TestImplementFeatureImportanceAnalysisIntegration)
    )
