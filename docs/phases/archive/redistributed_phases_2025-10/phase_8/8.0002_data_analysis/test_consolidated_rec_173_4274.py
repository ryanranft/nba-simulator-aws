...
from implement_consolidated_rec_173_4274 import (
    EnhancePlayerSimilarityAnalysisUsingBertEmbeddings,
)
...
class TestEnhancePlayerSimilarityAnalysisUsingBertEmbeddings(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.implementation = EnhancePlayerSimilarityAnalysisUsingBertEmbeddings(
            self.config
        )
...
class TestEnhancePlayerSimilarityAnalysisUsingBertEmbeddingsIntegration(
    unittest.TestCase
):
...
def run_tests():
    ...
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestEnhancePlayerSimilarityAnalysisUsingBertEmbeddings
        )
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestEnhancePlayerSimilarityAnalysisUsingBertEmbeddingsIntegration
        )
    )
