#!/usr/bin/env python3
"""
Test Suite: Implement Simple Random Sampling for Initial Data Exploration

Tests for rec_020 implementation.
"""
...
from implement_rec_020 import ImplementSimpleRandomSamplingForInitialDataExploration


class TestRec020(unittest.TestCase):
    """Test suite for Implement Simple Random Sampling for Initial Data Exploration."""

    def setUp(self):
        """Set up test fixtures."""
        self.impl = ImplementSimpleRandomSamplingForInitialDataExploration()
...
def run_tests():
    """Run test suite."""
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRec020)
