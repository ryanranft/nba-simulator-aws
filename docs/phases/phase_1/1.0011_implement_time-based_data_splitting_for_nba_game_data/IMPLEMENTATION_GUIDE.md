# Implementation Guide: Implement Time-Based Data Splitting for NBA Game Data
...
### Step 1: Step 1: Ensure all data points have a timestamp associated with them (e.g., game date).
...
### Step 2: Step 2: Sort the data by timestamp.
...
### Step 3: Step 3: Select a cutoff date to split the data into training, validation and test sets.  Ensure there is no overlap.
...
### Step 4: Step 4: Verify that there is no data leakage by checking the dates of the data in each set.
...
class TestRec127(unittest.TestCase):
    def test_setup(self):
