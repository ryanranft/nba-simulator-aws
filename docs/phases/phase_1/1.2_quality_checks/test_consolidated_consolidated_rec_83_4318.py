...
from implement_consolidated_consolidated_rec_83_4318 import (
    EstablishDataQualityMonitoringAndAlerting,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestEstablishDataQualityMonitoringAndAlerting)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestEstablishDataQualityMonitoringAndAlertingIntegration
        )
    )
