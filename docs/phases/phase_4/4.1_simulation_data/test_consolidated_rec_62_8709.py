...
from implement_consolidated_rec_62_8709 import (
    CollectUserFeedbackToImproveSimulationQuality,
)
...
def run_tests():
    ...
    # Add test classes
    suite.addTests(
        loader.loadTestsFromTestCase(TestCollectUserFeedbackToImproveSimulationQuality)
    )
    suite.addTests(
        loader.loadTestsFromTestCase(
            TestCollectUserFeedbackToImproveSimulationQualityIntegration
        )
    )
