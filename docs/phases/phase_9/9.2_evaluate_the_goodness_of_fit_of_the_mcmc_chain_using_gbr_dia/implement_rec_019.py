...
def main():
    ...
    print(f"=" * 80)
    print(f"Evaluate the Goodness of Fit of the MCMC Chain using GBR Diagnostics and other convergence metrics")
    print(f"=" * 80)
    
    # Initialize
    impl = EvaluateTheGoodnessOfFitOfTheMcmcChainUsingGbrDiagnosticsAndOtherConvergenceMetrics()
