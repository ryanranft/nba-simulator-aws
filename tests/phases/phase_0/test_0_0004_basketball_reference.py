...
Usage:
    # Run all tests
    pytest tests/phases/phase_0/test_0_0004_basketball_reference.py -v

    # Run specific test class
    pytest tests/phases/phase_0/test_0_0004_basketball_reference.py::TestPhase04S3Access -v

    # Run without slow tests
    pytest tests/phases/phase_0/test_0_0004_basketball_reference.py -v -m "not slow"
