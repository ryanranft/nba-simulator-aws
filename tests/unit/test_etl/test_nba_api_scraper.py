...
class TestNBAAPIPlayerStatsScraping:
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            async with nba_api_scraper:
                stats = await nba_api_scraper.scrape_player_stats(
                    season="2024-25", stat_type="traditional"
                )
    ...
    async def test_scrape_player_stats_advanced(
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            async with nba_api_scraper:
                stats = await nba_api_scraper.scrape_player_stats(
                    season="2024-25", stat_type="advanced"
                )
            ...
            for player in stats:
                assert (
                    "PIE" in player
                    or "OFFRTG" in player
                    or "advanced" in str(player).lower()
                )
...
class TestNBAAPIBoxScoreScraping:
    ...
    async def test_scrape_box_score_traditional(
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            async with nba_api_scraper:
                box_score = await nba_api_scraper.scrape_box_score_traditional(game_id)
    ...
    async def test_scrape_box_score_advanced(
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            async with nba_api_scraper:
                box_score = await nba_api_scraper.scrape_box_score_advanced(game_id)
...
class TestNBAAPIShotChartScraping:
    ...
    async def test_scrape_shot_chart(
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            assert all("LOC_X" in shot or "x" in str(shot).lower() for shot in shots)
...
class TestNBAAPILineupData:
    ...
    @pytest.mark.asyncio
    async def test_scrape_lineup_stats(self, nba_api_scraper, mock_nba_lineup_response):
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            async with nba_api_scraper:
                lineups = await nba_api_scraper.scrape_lineup_stats(season=season)

            assert isinstance(lineups, list)
            # Lineup data includes 5-player combinations

    @pytest.mark.asyncio
    async def test_scrape_team_lineups(self, nba_api_scraper, mock_nba_lineup_response):
...
class TestNBAAPIScoreboard:
    ...
    @pytest.mark.asyncio
    async def test_scrape_scoreboard_today(
        self, nba_api_scraper, mock_nba_scoreboard_response
    ):
...
class TestNBAAPIS3Integration:
    ...
    @pytest.mark.asyncio
    async def test_save_to_s3(self, nba_api_scraper, mock_nba_player_stats_response):
        ...
        "resultSets": [
            {
                ...
                "rowSet": [["2544", "LeBron James", 0.158, 117.2, 110.3]],
            }
        ]
    }
        ...
        "resultSets": [
            {
                ...
                "rowSet": [["0022400123", "2024-11-01", "LAL vs. BOS", "L"]],
            }
        ]
    }
        ...
        "resultSets": [
            {
                ...
                "rowSet": [["2544", "LeBron James", "35:00", 28]],
            }
        ]
    }
        ...
        "resultSets": [
            {
                ...
                "rowSet": [["2544", "LeBron James", 118.5, 108.2]],
            }
        ]
    }
        ...
        "resultSets": [
            {
                ...
                "rowSet": [
                    [
                        "123-456-789-012-345",
                        "James-Davis-Reaves-Russell-Hachimura",
                        125.5,
                        8.2,
                    ]
                ],
        ...
        "resultSets": [
            {
                ...
                "rowSet": [["0022400123", "1610612747", "1610612738"]],
            }
        ]
    }
