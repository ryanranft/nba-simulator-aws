...
class TestESPNScheduleScraping:
    ...
    @pytest.mark.asyncio
    async def test_scrape_schedule_success(self, espn_scraper, mock_espn_schedule_response):
    ...
    @pytest.mark.asyncio
    async def test_scrape_schedule_specific_date(self, espn_scraper, mock_espn_schedule_response):
...
class TestESPNPlayByPlayScraping:
    ...
    @pytest.mark.asyncio
    async def test_scrape_play_by_play_success(self, espn_scraper, mock_espn_pbp_response):
    ...
    async def test_scrape_play_by_play_with_validation(
        ...
        with patch('aiohttp.ClientSession.get') as mock_get:
            ...
            async with espn_scraper:
                plays = await espn_scraper.scrape_play_by_play(
                    game_id, validate=True
                )
    ...
    async def test_scrape_play_by_play_save_to_s3(
        ...
        with patch('aiohttp.ClientSession.get') as mock_get:
            ...
            with patch.object(espn_scraper, 'save_to_s3') as mock_save:
                async with espn_scraper:
                    await espn_scraper.scrape_play_by_play(
                        game_id, save_s3=True
                    )
...
class TestESPNBoxScoreScraping:
    ...
    @pytest.mark.asyncio
    async def test_scrape_box_score_success(self, espn_scraper, mock_espn_boxscore_response):
    ...
    @pytest.mark.asyncio
    async def test_scrape_box_score_player_stats(self, espn_scraper, mock_espn_boxscore_response):
    ...
    @pytest.mark.asyncio
    async def test_scrape_box_score_team_totals(self, espn_scraper, mock_espn_boxscore_response):
...
class TestESPNDataValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_schedule_data(self, espn_scraper, mock_espn_schedule_response):
    ...
    @pytest.mark.asyncio
    async def test_validation_report_generation(self, espn_scraper, mock_espn_schedule_response):
...
class TestESPNS3Integration:
    ...
    async def test_save_to_s3(self, espn_scraper, mock_espn_schedule_response):
        ...
        with patch('aiohttp.ClientSession.get') as mock_get:
            ...
            with patch.object(espn_scraper, 'save_to_s3') as mock_save:
                async with espn_scraper:
                    await espn_scraper.scrape_schedule(
    ...
    @pytest.mark.asyncio
    async def test_s3_upload_error_handling(self, espn_scraper, mock_espn_schedule_response):
