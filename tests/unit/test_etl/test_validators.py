...
class TestValidationReport:
    ...
    def test_report_is_valid(self):
        ...
        report.add_result(
            ValidationResult(
                is_valid=True, level=ValidationLevel.WARNING, message="Warning"
            )
        )
        assert report.is_valid is True
        ...
        report.add_result(
            ValidationResult(
                is_valid=False, level=ValidationLevel.ERROR, message="Error"
            )
        )
    ...
    def test_report_counts(self):
        ...
        report.add_result(
            ValidationResult(is_valid=True, level=ValidationLevel.INFO, message="Info")
        )
        report.add_result(
            ValidationResult(
                is_valid=True, level=ValidationLevel.WARNING, message="Warning 1"
            )
        )
        report.add_result(
            ValidationResult(
                is_valid=True, level=ValidationLevel.WARNING, message="Warning 2"
            )
        )
        report.add_result(
            ValidationResult(
