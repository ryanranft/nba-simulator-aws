...
class TestPublicSchemaIntegration:
    ...
    def test_all_40_public_tables_exist(self, mock_db_connection):
        ...
        expected_tables = [
            'box_score_players', 'box_score_snapshots', 'box_score_teams',
            'box_score_verification', 'dims_approval_log', 'dims_config',
            'dims_event_log', 'dims_metrics_history', 'dims_metrics_snapshots',
            'dims_verification_runs', 'game_state_snapshots', 'game_states',
            'games', 'games_summary', 'hoopr_play_by_play', 'hoopr_player_box',
            'hoopr_schedule', 'hoopr_team_box', 'lineup_snapshots',
            'nba_api_comprehensive', 'nba_api_game_advanced', 'nba_api_player_dashboards',
            'nba_api_player_tracking', 'nba_api_team_dashboards', 'play_by_play',
            'player_biographical', 'player_game_stats', 'player_plus_minus_snapshots',
            'player_snapshot_stats', 'player_snapshots', 'players', 'plays',
            'possession_metadata', 'possession_panel', 'possession_panel_pbpstats',
            'quarter_box_scores', 'team_game_stats', 'team_seasons', 'teams',
            'temporal_events'
        ]
