...
class TestDatabaseCredentials:
    ...
    @patch.dict(os.environ, {"DB_USER": "postgres", "DB_PASSWORD": "password123"})
    @patch("nba_simulator.config.loader.Path")
    ...
    @patch.dict(
        os.environ, {"RDS_USERNAME": "rds_user", "RDS_PASSWORD": "rds_password"}
    )
    @patch("nba_simulator.config.loader.Path")
    ...
    @patch.dict(os.environ, {"DB_USER": "db_user", "RDS_USERNAME": "rds_user"})
    @patch("nba_simulator.config.loader.Path")
...
class TestConnectionStringConstruction:
    ...
    @patch.dict(os.environ, {"DB_HOST": "localhost", "DB_NAME": "test_db"})
    @patch("nba_simulator.config.loader.Path")
...
class TestRDSConfiguration:
    ...
    @patch.dict(os.environ, {"RDS_HOST": "nba-rds.us-west-2.rds.amazonaws.com"})
    @patch("nba_simulator.config.loader.Path")
...
class TestDatabaseConfigConsistency:
    ...
    @patch.dict(os.environ, {"DB_HOST": "host1", "DB_NAME": "db1"})
    @patch("nba_simulator.config.loader.Path")
