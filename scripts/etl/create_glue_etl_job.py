    ...
    glue.create_connection(
        ConnectionInput={
            ...
            "PhysicalConnectionRequirements": {
                ...
                "AvailabilityZone": subnet_group["Subnets"][0][
...
print(
    f'   aws glue start-job-run --job-name {job_name} --arguments \'{{"--year":"1993"}}\''
)
print()
...
print(
    f"   https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#logsV2:log-groups/log-group/$252Faws-glue$252Fjobs$252Foutput"
)
