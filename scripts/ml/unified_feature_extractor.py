...
=== PANEL DATA INTEGRATION (Updated October 17, 2025) ===

This base class provides 249 static features.

For ENHANCED features with temporal context (84% accuracy):
    Use PanelDataFeatureExtractor instead (549 features = 249 static + 300 panel)
    ...
    # Result: 249 static + 300 panel = 549 total features
    # Accuracy: 84% (vs 63% with static features only)

Migration Guide: docs/PANEL_DATA_MIGRATION_GUIDE.md

=== BACKWARD COMPATIBILITY ===

This class remains unchanged and fully backward compatible.
All existing code using UnifiedFeatureExtractor continues to work.
"""
...
class UnifiedFeatureExtractor:
    ...
    def _init_feature_catalog(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "espn_team": [
                ...
                "team_three_pointers_made",
                "team_three_pointers_attempted",
            ...
            "nba_stats_tracking": [
                ...
                "contested_shots",
                "uncontested_shots",
                "contested_shot_percentage",
                "shot_distance_avg",
                "shot_distance_median",
                "catch_shoot_attempts",
                "pull_up_attempts",
                "drives",
                "drive_frequency",
                "points_per_drive",
                "assist_percentage_on_drives",
                "turnover_percentage_on_drives",
                "screen_assists",
            ...
            "nba_stats_defense": [
                ...
                "defensive_matchups",
                "partial_possessions",
                "player_points_allowed",
                "team_points_allowed",
                "matchup_assists_allowed",
                "matchup_potential_assists_allowed",
                "matchup_turnovers_forced",
                "blocks_on_matchup",
                "matchup_field_goals_made_against",
                "matchup_field_goals_attempted_against",
                ...
                "help_blocks",
                "help_steals",
                "rim_protection_frequency",
                "rim_field_goal_percentage_against",
            ...
            "nba_stats_shot_quality": [
                ...
                "shot_value_points",
                "shot_quality_avg",
                "shot_clock_2_4_seconds_frequency",
                "shot_clock_4_7_seconds_frequency",
                "shot_clock_7_15_seconds_frequency",
                "shot_clock_15_24_seconds_frequency",
                "shot_clock_early_frequency",
                "shot_clock_late_frequency",
                "dribble_range_0_frequency",
                "dribble_range_1_frequency",
                "dribble_range_2_frequency",
                "dribble_range_3_6_frequency",
                "dribble_range_7plus_frequency",
                "touch_time_range_0_2_frequency",
                "touch_time_range_2_4_frequency",
                "touch_time_range_4_6_frequency",
                "touch_time_range_6plus_frequency",
                "closest_defender_0_2_frequency",
                "closest_defender_2_4_frequency",
                "closest_defender_4_6_frequency",
                "closest_defender_6plus_frequency",
                "contested_shot_efficiency",
                "uncontested_shot_efficiency",
                "shot_quality_index",
            ...
            "hoopr_lineup": [
                ...
                "off_court_rating",
                "on_off_differential",
                "teammate_assist_opportunities",
                "teammate_points_created",
                "usage_rate_with_lineup",
                "shot_attempts_with_lineup",
                "rebounding_opportunities",
                "spacing_impact",
                "floor_spacing_rating",
                "teammate_synergy_score",
                "lineup_chemistry",
                "lineup_experience_minutes",
            ...
            "hoopr_player": [
                ...
                "player_value_added",
                "player_win_contribution",
                "player_clutch_rating",
                "player_consistency_score",
                "player_reliability_index",
                "player_momentum_indicator",
            ...
            "bref_advanced": [
                ...
                "game_score_advanced",
                "hollinger_assist_ratio",
            ],
            "bref_four_factors": [
                # Four Factors of Basketball Success (12)
                "four_factors_shooting",
                "four_factors_turnovers",
                "four_factors_rebounding",
                "four_factors_free_throws",
                "offensive_four_factors_index",
                "defensive_four_factors_index",
                "pace_adjusted_offensive_rating",
                "pace_adjusted_defensive_rating",
                "strength_of_schedule_adjusted_rating",
                "pythagorean_wins",
                "pythagorean_losses",
            ...
            "bref_team": [
                ...
                "team_pace",
                "team_offensive_rating_bref",
                "team_defensive_rating_bref",
                "team_net_rating",
            ...
            "derived_efficiency": [
                ...
                "points_per_field_goal_attempt",
                "points_per_true_shot_attempt",
                "rebounds_per_minute",
                "assists_per_field_goal",
            ...
            "derived_momentum": [
                ...
                "scoring_run_current",
                "scoring_run_max",
                "momentum_shift_count",
                "lead_stability_index",
                "comeback_probability",
                "game_flow_volatility",
            ],
            "derived_contextual": [
    ...
    def extract_nba_stats_features(self, game_id: str, season: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"✓ Extracted {len(features)} NBA Stats features for game {game_id}"
            )
    ...
    def extract_hoopr_features(self, game_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"✓ Extracted {len(features)} hoopR features for game {game_id}"
            )
    ...
    def extract_bref_features(self, game_id: str, season: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"✓ Extracted {len(features)} Basketball Reference features for game {game_id}"
            )

        except Exception as e:
            logger.error(
                f"Error extracting Basketball Reference features for {game_id}: {e}"
            )
    ...
    def _extract_hoopr_player_features(
    ...
    def _extract_bref_advanced_features(
