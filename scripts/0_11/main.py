#!/usr/bin/env python3
"""
Phase 0.11: RAG Pipeline Main Interface
...
from scripts.db.0_11_init import RAGDatabaseInitializer
from scripts.0_11.embedding_pipeline import EmbeddingPipeline
from scripts.0_11.vector_search import VectorSearch
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Phase 0.11: RAG Pipeline for NBA Data',
