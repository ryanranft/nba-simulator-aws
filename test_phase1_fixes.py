#!/usr/bin/env python3
"""
Test script for Phase 1 possession detection bug fixes.

Tests the fixed detector on 5 games to verify:
1. NULL team_id rebounds are handled correctly
2. Made shot duplicate events are removed
3. Team balance is improved (≤2 possession difference)
4. Detection rate improved from 90% toward 95%+
...
def load_game_events(game_id: str) -> List[Dict]:
    ...
    query = """
        ...
        WHERE game_id = %s
        ORDER BY period, game_clock_seconds DESC
    """
